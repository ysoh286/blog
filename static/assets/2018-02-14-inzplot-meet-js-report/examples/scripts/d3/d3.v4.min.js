...
(function (t, n) {
	...
	function l(t, n, e) {
		...
		if (u > 0)
			for (
				t = Math.ceil(t / u), n = Math.floor(n / u), o = new Array((i = Math.ceil(n - t + 1)));
				++a < i;
			...
			for (
				t = Math.floor(t * u), n = Math.ceil(n * u), o = new Array((i = Math.ceil(t - n + 1)));
				++a < i;
	...
	function T(t, n) {
		function e(e) {
			var h = null == i ? (n.ticks ? n.ticks.apply(n, r) : n.domain()) : i,
				...
				S = w.select('text');
			(b = b.merge(
				b.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', '#000')
			)),
				(w = w.merge(N)),
				(k = k.merge(
					N.append('line')
				...
				m
					...
					.attr('text-anchor', t === Ws ? 'start' : t === Gs ? 'end' : 'middle'),
				m.each(function () {
					this.__axis = y;
				});
		}
	...
	function U(t, n, e, r, i, o, u) {
		...
		for (a = 0; a < l; ++a)
			(c = n[a]) &&
				((p[a] = s = uf + u.call(c, c.__data__, a, n)), s in f ? (i[a] = c) : (f[s] = c));
		for (a = 0; a < h; ++a)
				...
				(function () {
					...
					for (; e; )
						e._call
							...
							: ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Yf = n)));
					(Bf = t), kn(r);
				})(),
				(pl = 0);
		}
	...
	function kn(t) {
		if (!cl) {
			...
			t - pl > 24
				? (t < 1 / 0 && (sl = setTimeout(Tn, t - vl.now() - dl)), fl && (fl = clearInterval(fl)))
				: (fl || ((hl = vl.now()), (fl = setInterval(Nn, ll))), (cl = 1), gl(Tn));
		}
	}
	function Sn(t, n, e) {
		var r = new bn();
	...
	function Ln(t, n) {
		var e;
		return (
			'number' == typeof n ? an : n instanceof Et ? Hf : (e = Et(n)) ? ((n = e), Hf) : sn
		)(t, n);
	}
	function qn(t, n, e, r) {
		...
		function u() {
			...
			if (f.apply(this, arguments)) {
				var a,
					...
					T =
						'selection' === (t.event.metaKey ? (M = 'overlay') : M) ? Kl : t.event.altKey ? eh : nh,
					N = n === ih ? null : sh[M],
					k = n === rh ? null : fh[M],
					S = Qn(w),
					E = S.extent,
	...
	function kr(t, n) {
		...
		var e = Lp((n *= Cp)),
			...
			o = Fp(n),
			u = Rp(
				Yp((u = xp * o - bp * i) * u + (u = bp * r - mp * o) * u + (u = mp * i - xp * r) * u),
				mp * r + xp * i + bp * o
			);
		(ap += u),
			(lp += u * (mp + (mp = r))),
	...
	function Ir(t, n, e, r, i, o) {
		if (e) {
			...
			null == i
				? ((i = n + r * Ep), (o = n - c / 2))
				: ((i = Yr(u, i)), (o = Yr(u, o)), (r > 0 ? i < o : i > o) && (i += r * Ep));
	...
	function $r(t, n) {
		...
		for (var a = 0, c = t.length; a < c; ++a)
			if ((f = (s = t[a]).length))
				for (
					var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + Sp, d = Fp(p), v = Lp(p), g = 0;
					g < f;
					++g, h = y, d = x, v = b, l = _
				) {
					var _ = s[g],
			...
			(n.clipExtent = function (t) {
				return arguments.length
					? ((k =
							null == t
								? ((N = f = l = h = null), pi)
								: Jr((N = +t[0][0]), (f = +t[0][1]), (l = +t[1][0]), (h = +t[1][1]))),
					  i())
					: null == N
					? null
					: [
						...
						(e[r] = (function (t, n) {
							return function (e, r) {
								t._tasks[n] &&
									...
									(t._tasks[n] = null),
									null == t._error &&
										(null != e ? Qo(t, e) : ((t._data[n] = r), t._waiting ? Go(t) : Jo(t))));
							};
						})(t, n)),
							--t._waiting,
							++t._active,
				...
				return (function (n, e, r) {
					...
					switch ((r = De(null == r ? ',f' : r)).type) {
						case 's':
							...
							return (
								null != r.precision || isNaN((i = Be(a, c))) || (r.precision = i),
								t.formatPrefix(r, c)
							);
						case '':
						case 'e':
		...
		function e(t, n) {
			return function (e) {
				...
				if (('p' in u && (u.H = (u.H % 12) + 12 * u.p), 'V' in u)) {
					...
					'w' in u || (u.w = 1),
						'Z' in u
							? ((i = (o = (i = Lu(qu(u.y))).getUTCDay()) > 4 || 0 === o ? og.ceil(i) : og(i)),
							  (i = eg.offset(i, 7 * (u.V - 1))),
							  (u.y = i.getUTCFullYear()),
							  (u.m = i.getUTCMonth()),
							  (u.d = i.getUTCDate() + ((u.w + 6) % 7)))
							: ((i = (o = (i = n(qu(u.y))).getDay()) > 4 || 0 === o ? qv.ceil(i) : qv(i)),
	...
	function Ic(t, n, e) {
		var r = t._x1 - t._x0,
			...
			u = (e - t._y1) / (i || (r < 0 && -0)),
			a = (o * i + u * r) / (r + i);
		return (Fc(o) + Fc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) || 0;
	}
	function Yc(t, n) {
		var e = t._x1 - t._x0;
		...
		if (
			...
			(function (t, n, e, r) {
				for (var i, o = D_.length; o--; )
					(hs((i = D_[o]), t, n, e, r) &&
						ls(i, t, n, e, r) &&
						(Math.abs(i[0][0] - i[1][0]) > F_ || Math.abs(i[0][1] - i[1][1]) > F_)) ||
						delete D_[o];
			})(u, a, c, s),
				(function (t, n, e, r) {
					var i,
					...
					return t
						...
						.map(function (t) {
							var e = '',
								r = t.indexOf('.');
							if (
								(r >= 0 && ((e = t.slice(r + 1)), (t = t.slice(0, r))), t && !n.hasOwnProperty(t))
							)
	...
	ut.prototype = at.prototype = {
		...
		data: function (t, n) {
			...
			for (
				var o = i.length, u = new Array(o), a = new Array(o), c = new Array(o), s = 0;
				s < o;
				++s
			) {
				var f = r[s],
	...
	Nt(
		...
		kt(St, {
			...
			darker: function (t) {
				return (
					(t = null == t ? 0.7 : Math.pow(0.7, t)), new Wt(this.h, this.s, this.l * t, this.opacity)
				);
			},
			rgb: function () {
	...
	var Uf,
		...
		Qf = pn(
			function (t) {
				return null == t
					? Zf
					: (If || (If = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
		...
		selectAll: function (t) {
			...
			for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
				for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
					if ((c = s[l])) {
						for (
							var h, p = t.call(c, c.__data__, l, s), d = zn(c, e), v = 0, g = p.length;
							v < g;
							++v
						)
							...
							? (function (t, n, e) {
									...
									return function () {
										var u = I(this, t),
											a = e(this);
										return (
											null == a && (this.style.removeProperty(t), (a = I(this, t))),
	...
	(Uh.copy = function () {
		...
		(Uh.find = function (t, n, e) {
			...
			for (
				...
				if (
					!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l)
				)
					if (v.length) {
						var g = (i + u) / 2,
							_ = (o + a) / 2;
		...
		(Uh.visitAfter = function (t) {
			var n,
				...
				r = [];
			for (
				this._root && e.push(new be(this._root, this._x0, this._y0, this._x1, this._y1));
				(n = e.pop());
							...
							: i !== a &&
							  ...
							  (r = (function (t, n, e, r) {
									var i,
										...
										u = Fp(t - e);
									return zp(u) > Mp
										? Pp((Fp(n) * (o = Lp(r)) * Fp(e) - Fp(r) * (i = Lp(n)) * Fp(t)) / (i * o * u))
										: (n + r) / 2;
							  })(e, r, o, u)),
							  t.point(i, r),
							  t.lineEnd(),
		...
		(rs.prototype = {
			...
			insert: function (t, n) {
				...
				if (t) {
					...
					this._
						? ((t = as(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
						: ((n.P = n.N = null), (this._ = n), (e = null));
				for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
					e === (r = e.U).L
						? (i = r.R) && i.C
							? ((e.C = i.C = !1), (r.C = !0), (t = r))
							: (t === e.R && (os(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), us(this, r))
						: (i = r.L) && i.C
						? ((e.C = i.C = !1), (r.C = !0), (t = r))
						: (t === e.L && (us(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), os(this, r)),
						(e = t.U);
				this._.C = !1;
			},
			remove: function (t) {
				...
				if (
					...
					if (t && t.C) t.C = !1;
						...
						do {
							...
							if (t === i.L) {
								if (
									((n = i.R).C && ((n.C = !1), (i.C = !0), os(this, i), (n = i.R)),
									(n.L && n.L.C) || (n.R && n.R.C))
								) {
								...
								((n = i.L).C && ((n.C = !1), (i.C = !0), us(this, i), (n = i.L)),
								(n.L && n.L.C) || (n.R && n.R.C))
							) {
	...
	(Es.prototype = Ss.prototype),
		...
		(t.histogram = function () {
			function t(t) {
				...
				var c = e(a),
					...
					h = r(a, s, l);
				Array.isArray(h) ||
					((h = p(s, l, h)), (h = f(Math.ceil(s / h) * h, Math.floor(l / h) * h, h)));
			...
			return (
				...
				(t.thresholds = function (n) {
					return arguments.length
						? ((r = 'function' == typeof n ? n : Array.isArray(n) ? c(Ys.call(n)) : c(n)), t)
						: r;
				}),
				t
			);
		...
		(t.ribbon = function () {
			function t() {
				...
				if (
					...
					u.arc(0, 0, f, l, h),
					(l === g && h === _) ||
						(u.quadraticCurveTo(0, 0, v * lh(g), v * hh(g)), u.arc(0, 0, v, g, _)),
		...
		(t.drag = function () {
			...
			function c(e, r, i, o, u) {
				var a,
					...
					l = y.copy();
				if (
					it(new xt(n, 'beforestart', a, e, m, f[0], f[1], 0, 0, l), function () {
						return (
					...
					return function t(h) {
						...
						it(new xt(n, h, a, e, p, f[0] + c, f[1] + s, f[0] - d[0], f[1] - d[1], l), l.apply, l, [
							h,
							o,
							u
						]);
		...
		(t.geoPath = function (t, n) {
			function e(t) {
				return (
					t && ('function' == typeof o && i.pointRadius(+o.apply(this, arguments)), tr(t, r(i))),
					i.result()
				);
			}
			var r,
				...
				clipExtent: function (i) {
					return arguments.length
						? ((d =
								null == i
									? ((p = n = e = r = null), pi)
									: Jr((p = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))),
						  t())
						: null == p
						? null
						: [
		...
		(t.interpolateRainbow = function (t) {
			...
			return (jg.h = 360 * t - 100), (jg.s = 1.5 - 1.5 * n), (jg.l = 0.8 - 0.9 * n), jg + '';
		}),
						...
						M > e_
							? E > e_
								? ((g = rc(U, O, z, P, l, E, v)),
								  ...
								  E < k
										? c.arc(g.cx, g.cy, E, Gg(g.y01, g.x01), Gg(_.y01, _.x01), !v)
										: (c.arc(g.cx, g.cy, E, Gg(g.y01, g.x01), Gg(g.y11, g.x11), !v),
										  c.arc(
												0,
												0,
												l,
										  ...
										  c.arc(_.cx, _.cy, E, Gg(_.y11, _.x11), Gg(_.y01, _.x01), !v)))
							...
							f > e_ && w > e_
								? S > e_
									? ((g = rc(R, L, q, D, f, -S, v)),
									  ...
									  S < k
											? c.arc(g.cx, g.cy, S, Gg(g.y01, g.x01), Gg(_.y01, _.x01), !v)
											: (c.arc(g.cx, g.cy, S, Gg(g.y01, g.x01), Gg(g.y11, g.x11), !v),
											  c.arc(
													0,
													0,
													f,
											  ...
											  c.arc(_.cx, _.cy, S, Gg(_.y11, _.x11), Gg(_.y01, _.x01), !v)))
									: c.arc(0, 0, f, b, x, v)
								: c.lineTo(R, L);
					}
				else c.moveTo(0, 0);
		...
		(t.stack = function () {
			...
			return (
				...
				(t.order = function (n) {
					return arguments.length
						? ((e = null == n ? Gc : 'function' == typeof n ? n : Ga(a_.call(n))), t)
						: e;
				}),
				(t.offset = function (n) {
			...
			if ((i = t.length) > 0 && (r = (e = t[n[0]]).length) > 0) {
				for (var e, r, i, o = 0, u = 1; u < r; ++u) {
					for (var a = 0, c = 0, s = 0; a < i; ++a) {
						for (
							var f = t[n[a]], l = f[u][1] || 0, h = (l - (f[u - 1][1] || 0)) / 2, p = 0;
							p < a;
							++p
						) {
							var d = t[n[p]];
		...
		(t.zoom = function () {
						...
						e = ct(t.event.view)
							.on(
								...
								function () {
									...
									n.zoom(
										'mouse',
										y(r(n.that.__zoom, (n.mouse[0] = pt(n.that)), n.mouse[1]), n.extent, w)
									);
								},
								!0
							)
			...
			return (
				...
				(a.prototype = {
					start: function () {
						return (
							1 == ++this.active && ((this.index = k.push(this) - 1), this.emit('start')), this
						);
					},
					zoom: function (t, n) {
						return (
						...
						return (
							0 == --this.active && (k.splice(this.index, 1), (this.index = -1), this.emit('end')),
							this
						);
					},
					emit: function (t) {
